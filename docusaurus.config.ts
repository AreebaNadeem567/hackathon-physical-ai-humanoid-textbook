...
const config: Config = {
  ...
  organizationName: 'Areeba Nadeem',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/AreebaNadeem567',
        },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/AreebaNadeem567',
          label: 'GitHub',
          position: 'right',
        },
      ],
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'LinkedIn',
              href: 'https://www.linkedin.com/in/areeba-nadeem-81206b2bb/',
            },
          ],
        },
        {
